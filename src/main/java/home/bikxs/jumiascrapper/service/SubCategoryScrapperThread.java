...
public class SubCategoryScrapperThread implements Runnable {
	...
	public SubCategoryScrapperThread(SubCategory subCategory, HttpHeaders headers, ConcurrentMap<String, Item> itemConcurrentMap, RestTemplate restTemplate, Boolean deep_search) {
